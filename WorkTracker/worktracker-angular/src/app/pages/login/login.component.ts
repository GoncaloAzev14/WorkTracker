...
@Component({
  ...
  template: `
    <div class="login-container">
      <div class="card">
        ...
        <div class="link-text">
          Não tens conta? <a routerLink="/signup">Criar conta</a>
        </div>
      </div>
    </div>
  `,
  styles: [`
    ...
    .error { color: #ff3b30; margin-top: 10px; font-size: 14px; }.link-text { margin-top: 20px; font-size: 14px; color: #8e8e93; }
    .link-text a { color: #007aff; text-decoration: none; font-weight: 500; }
  `]
})
